...
* git add  - **команда для добавления изменения или файла в отслеживание**
...
* git commit -m "message" - **команда для закрепления изменения в репозиторий**
...
* git reset --hard - **почти как git reset но безопаснее: не получится потерять изменения в рабочей директории**
...
* git checkout + 4 символа номера коммита - **команда для перемещения между коммитами**
